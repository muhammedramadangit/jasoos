...
class RecentTasksBloc extends Bloc<AppEvent, AppState> {
  RecentTasksBloc() : super(Loading()) {
    on<Update>(_update);
    on<Get>(_get);
  }
  static RecentTasksBloc get instance => BlocProvider.of(CustomNavigator.navigatorState.currentContext!);
